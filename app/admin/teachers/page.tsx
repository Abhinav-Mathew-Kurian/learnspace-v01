  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
            ...
            {displayed.map((t) => (
              <div key={t._id} className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
                ...
                <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100">
                  ...
                  <button onClick={() => setDeleteTarget({ id: t._id, name: t.name })} className="text-xs text-red-600 font-medium">Delete</button>
                </div>
              </div>
            ))}
          </div>
                  ...
                  <tr key={t._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => setDeleteTarget({ id: t._id, name: t.name })} className="text-xs text-red-600 hover:text-red-800 underline">Delete</button>
                      </div>
                    </td>
                  </tr>
                ))}
      ...
      <ConfirmDialog
        ...
        message={`Are you sure you want to permanently delete ${deleteTarget?.name ?? 'this teacher'}? This cannot be undone.`}
        confirmLabel="Delete"
        loading={modalLoading}
